...
const infoPopup = () => {
  document.getElementById("infoo").innerHTML =
    "<h2>NASIL OYNANIR?</h2> <p>" +
    "\n" +
    "\nPaketWordle'ı 6 denemede bulun." +
    "\n" +
    "\nHer tahmin 5 harfli bir kelime olmalıdır. Göndermek için ENTER'a basın." +
    "\n" +
    "\nHer tahminden sonra kutucukların renkleri tahmininizin yakınlığına göre değişecektir.</p>" +
    "\n" +
    "\n\u{1F7E9} harf kelimede var ve doğru yerde.</br> " +
    "\n\u{1F7E8} harf kelimede var fakat yanlış yerde.</br> " +
    "\n\u{2B1B} harf kelimede yok.</br>";
...
const showUserStatistics = () => {
  ...
  const statisticsString = `Bulunan kelime sayısı ${userStatistics.totalWordsFound}\n`;
  ...
  attemptsPerWordDisplay.innerHTML = `<p>Doğru kelime: <b>${wordle}.</b> \n</p>`;
